...
import { FormContainer, FormView, InputForm, Logo, Title,  SubscribeButton, ForgotButton, View, Subtitle } from './worker-register.style';
...
export default function WorkerRegisterScreen() {
  ...
  interface SignUpFormValues {
    ...
    async function handleSignup(values: SignUpFormValues){
      ...
      await SecureStore.setItemAsync("user_role", "worker");
    ...
    async function handleVerifyUser() {
      ...
      try {
        ...
        // Redirecionar explicitamente para a rota "worker-form"
